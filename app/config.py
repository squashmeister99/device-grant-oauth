"""
Configuration management for the native (host-run) device authorization grant client.
...
class Config(BaseSettings):
    ...
    # Keycloak configuration (Keycloak runs in Docker, exposed on localhost:8080)
    ...
    poll_timeout: int = Field(default=300, alias="POLL_TIMEOUT")
    ...
    # Token storage (local to this host, not a container volume)
    ...
    web_ui_host: str = Field(default="127.0.0.1", alias="WEB_UI_HOST")
